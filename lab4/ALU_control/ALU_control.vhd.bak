...
BEGIN
  ...
  BEGIN
	 IF (ALUOp = "00" OR ((ALUOp = "11" OR ALUOp = "10") AND Funct7 = "0000000" AND Funct3 = "000")) THEN
	   Opcode <= "0000";
	 ELSIF (ALUOp = "01" OR ((ALUOp = "11" OR ALUOp = "10") AND Funct7 = "0100000" AND Funct3 = "000")) THEN
	   Opcode <= "0010";
	 ...
	 ELSIF ((ALUOp = "11" OR ALUOp = "10") AND Funct7 = "0110011" AND Funct3 = "100") THEN
      Opcode <= "0100";
	 ELSIF ((ALUOp = "11" OR ALUOp = "10") AND Funct7 = "0000000" AND Funct3 = "001") THEN
      Opcode <= "0001";
	 ELSIF ((ALUOp = "11" OR ALUOp = "10") AND Funct7 = "0010011" AND Funct3 = "101") THEN
	   Opcode <= "0011";
