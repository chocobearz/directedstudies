...
-- *****************************************************************************
-- Generated on "04/30/2020 05:59:45"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          datapathmany
-- 
...
ENTITY datapathmany_vhd_vec_tst IS
END datapathmany_vhd_vec_tst;
ARCHITECTURE datapathmany_arch OF datapathmany_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
